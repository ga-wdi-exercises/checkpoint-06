...
```text
// The ui-sref directive is associated with the use of the ui-router. It acts as a link to another page. Very similar to href..but more angular.
```
...
```js
var url = "https://localhost:3000.json"
  $.ajax({
    url: url,
    type: "get",
    dataType: "json"
